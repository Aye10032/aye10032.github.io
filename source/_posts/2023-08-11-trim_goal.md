...
mkdir after_trim
mkdir trim_result
trim_galore --paired --cores 2 --phred33 --illumina --stringency 1 --quality 25 --gzip --fastqc_args "-o trim_result/ -f fastq -t 8" --output_dir after_trim/ raw_data/H1_1.fq.gz raw_data/H1_2.fq.gz
```
